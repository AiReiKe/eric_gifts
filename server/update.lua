...
local resourceName = "eric_gifts"

local GetRepoInformations = function()
    local repoVersion, repoURL, repoBody = nil, nil, nil

    PerformHttpRequest("https://api.github.com/repos/AiReiKe/eric_gifts/releases/latest", function(err, response, headers)
        if err == 200 then
            ...
            repoURL = "https://github.com/AiReiKe/eric_gifts"
        end
    end, "GET")
...
CreateThread(function()
    if GetCurrentResourceName() ~= "eric_gifts" then
        resourceName = "eric_gifts (" .. GetCurrentResourceName() .. ")"
    end
    PerformHttpRequest("https://api.github.com/repos/AiReiKe/eric_gifts/releases/latest", CheckVersion, "GET")
end)